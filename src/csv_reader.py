...
TPEX_EQUITIES_CSV_PATH = os.path.join(PACKAGE_DIRECTORY, "../data/tpex_equities.csv")
TWSE_EQUITIES_CSV_PATH = os.path.join(PACKAGE_DIRECTORY, "../data/twse_equities.csv")
